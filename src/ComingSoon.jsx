          ...
          <div className="w-full md:w-2/3 p-8 md:p-12">
            ...
            <main>
              ...
              <p className="text-gray-600 mb-6">
                ...
                we go live — plus early-access invitations.
              </p>
              ...
              <div className="mt-6 text-sm text-gray-500">
                <p>
                  Need to reach us? <a href="mailto:hello@atnsolutions.co.za" className="text-blue-600 hover:underline">hello@atnsolutions.co.za</a>
                </p>
                <p className="mt-2">Follow us: <a className="text-blue-600 hover:underline" href="#">LinkedIn</a> • <a className="text-blue-600 hover:underline" href="#">GitHub</a></p>
              </div>
            </main>
          </div>
